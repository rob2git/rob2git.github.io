 ...
 * BLOG POSTS
 * ----------
 * Generated by admin.html on 2026-08-21.
...
const POSTS = [
  ...
  }/**,
  {
    ...
    date: "2026-07-28",
    tags: ["Design","Process"],
    excerpt: "Most interfaces don't fail because they're missing a feature. They fail because nothing was left out.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Fifty-two short posts later, the habit turned out to matter more than any single piece of writing.",
    content: `
  ...
  },
  {
    ...
    date: "2026-05-02",
    tags: ["Work","Process"],
    excerpt: "The teams that collaborate well remotely aren't the ones with the most meetings — they're the ones with the best written record.",
    content: `
  ...
  },
  {
    ...
    date: "2026-03-19",
    tags: ["Work"],
    excerpt: "Good notes aren't a transcript of what was said. They're a record of what changed.",
    content: `
  ...
  },
  {
    ...
    date: "2026-01-22",
    tags: ["Tools"],
    excerpt: "Every tool I've used for more than five years shares one property: it stores its data as plain text.",
    content: `
